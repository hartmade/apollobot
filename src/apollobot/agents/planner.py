...
class DataRequirement(BaseModel):
    ...
    description: str = ""
    source_type: str = "mcp_server"  # mcp_server, download, generate
    server_name: str = ""
...
CRITICAL: You MUST respond with ONLY valid JSON. No comments, no trailing commas,
no single-quoted keys, no markdown fences, no explanatory text before or after the JSON.
All keys and string values must use double quotes. The response must be parseable by
json.loads() directly.
"""
